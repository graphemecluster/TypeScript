...
export declare let a: number[] & [number];
export declare let b: number[] & [number, number];
export declare let c: number[] & [number, number];
export declare let d: (string | number)[] & [string | number, string | number];
export declare let e: number[] & [number, number, number];
export declare let f: number[] & [number, number, number, number];
export declare let g: number[] & [number, number, number, number, number];
